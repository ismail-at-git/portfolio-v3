...
export function Hero() {
    return (
        <section className="container mx-auto px-4 py-20 md:py-32 flex flex-col md:flex-row items-center gap-10">
            ...
            >
                <div className="inline-flex items-center rounded-lg bg-brand/10 px-3 py-1 text-sm font-medium text-brand ring-1 ring-inset ring-brand/20">
                    Available for Hire
                </div>
                <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
                    Hi, I&apos;m <span className="text-brand">Mohammed Ismail</span>
                </h1>
                ...
                <div className="flex items-center justify-center md:justify-start gap-4 pt-4">
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="p-3 bg-secondary rounded-full hover:bg-brand hover:text-white transition-all transform hover:scale-110"
                    >
                ...
                <div className="pt-6 flex flex-wrap justify-center md:justify-start gap-4">
                    <a href="#projects" className="inline-flex h-11 items-center justify-center rounded-md bg-brand px-8 py-2 text-sm font-medium text-white shadow transition-colors hover:bg-brand/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring">
                        View My Work
                    </a>
                    <a href="/resume.pdf" download className="inline-flex h-11 items-center justify-center rounded-md border border-input bg-background px-8 py-2 text-sm font-medium shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring">
                        Download Resume
                    </a>
                </div>
            </motion.div>
